...
const ALWAYS_ON: { path: string; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"]; priority: number }[] = [
...
const COMMERCE_ONLY: { path: string; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"]; priority: number }[] = [
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPaths = commerce ? [...ALWAYS_ON, ...COMMERCE_ONLY] : ALWAYS_ON;

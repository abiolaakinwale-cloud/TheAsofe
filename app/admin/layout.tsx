      ...
      <div className="border-b" style={{ borderColor: "var(--color-rule)" }}>
        <div className="max-w-[88rem] mx-auto px-6 lg:px-12 py-5 flex items-center justify-between gap-6 flex-wrap">
          <div className="flex items-center gap-8 lg:gap-10 text-[11px] tracking-[0.18em] uppercase font-medium" style={{ color: "var(--color-ink)" }}>
            ...
            <Link href="/admin/questions" className="lux-link">Questions</Link>
            <Link href="/admin/concierge" className="lux-link">Concierge</Link>
            <Link href="/admin/gift-cards" className="lux-link">Gift cards</Link>
            <Link href="/admin/referrals" className="lux-link">Referrals</Link>
            ...
            <Link href="/admin/customers" className="lux-link">Customers</Link>
